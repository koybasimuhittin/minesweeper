    ...
    : QWidget(parent)
{
    ...
    //     "QPushButton { border-image: url(:/sound/mute.png); background-color:white; border-radius: "
    //     "5px; margin: 5px;}"); // Set the unmute icon
...
//         muteButton->setStyleSheet(
//             "QPushButton { border-image: url(:/sound/mute.png); background-color:white; "
//             "border-radius: 5px; margin: 5px;}"); // Set the mute icon
//     } else {
//         audioOutput->setMuted(true); // Mute the sound
//         muteButton->setStyleSheet(
//             "QPushButton { border-image: url(:/sound/unmute.png); background-color:white; "
//             "border-radius: 5px; margin: 5px;}"); // Set the unmute icon
//     }
// }
